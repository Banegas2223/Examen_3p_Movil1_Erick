...
import com.example.examen_3p_movil1_erick.config.Utils;
...
public class Escuchar_audio_adapter extends RecyclerView.Adapter<Escuchar_audio_adapter.EscucharAudioViewHolder> {

    private Context context;
    private List<Entrevista> listaEntrevistas;
    private List<Boolean> seleccionados;

    public Escuchar_audio_adapter(Context context, List<Entrevista> listaEntrevistas) {
