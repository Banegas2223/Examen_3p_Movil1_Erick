...
import com.example.examen_3p_movil1_erick.config.*;
import com.example.examen_3p_movil1_erick.EntrevistaAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRegresar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ActividadListaEntrevistas.this, MainActivity.class);
