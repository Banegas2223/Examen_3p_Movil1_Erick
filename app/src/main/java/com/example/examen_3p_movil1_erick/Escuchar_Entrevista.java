...
public class Escuchar_Entrevista extends AppCompatActivity {
    ...
    private Escuchar_audio_adapter Escuchar_audio_adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_actividad_lista_entrevistas);
        ...
        Escuchar_audio_adapter = new Escuchar_audio_adapter(this, listaEntrevistas);
