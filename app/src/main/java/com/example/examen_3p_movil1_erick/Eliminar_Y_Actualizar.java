package com.example.examen_3p_movil1_erick;
...
import com.example.examen_3p_movil1_erick.config.Entrevista;
...
public class Eliminar_Y_Actualizar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eliminar_yactualizar);
        ...
        btnRegresar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Eliminar_Y_Actualizar.this, MainActivity.class);
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        if (!listaEntrevistas.isEmpty()) {
                            ...
                            Toast.makeText(Eliminar_Y_Actualizar.this, "No hay datos disponibles", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
        ...
        for (String id : idsFirestore) {
            db.collection("Entrevista")
                    ...
                    .addOnSuccessListener(aVoid -> {
                        ...
                        Toast.makeText(Eliminar_Y_Actualizar.this, "Eliminado de firebase ", Toast.LENGTH_SHORT).show();
                    })
                    .addOnFailureListener(e -> {
                        // Error al eliminar
                        // Puedes mostrar un mensaje de error o manejar la excepción aquí
                        Toast.makeText(Eliminar_Y_Actualizar.this, "Error al eliminar: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    });
        }
    }
}